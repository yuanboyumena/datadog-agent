...
func easyjsonF642ad3eDecodeGithubComDataDogDatadogAgentPkgSecurityModule(in *jlexer.Lexer, out *RuleEvent) {
...
func easyjsonF642ad3eEncodeGithubComDataDogDatadogAgentPkgSecurityModule(out *jwriter.Writer, in RuleEvent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v RuleEvent) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
func (v RuleEvent) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonF642ad3eEncodeGithubComDataDogDatadogAgentPkgSecurityModule(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *RuleEvent) UnmarshalJSON(data []byte) error {
...
func (v *RuleEvent) UnmarshalEasyJSON(l *jlexer.Lexer) {
